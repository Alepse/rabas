...
const Casiguran = () => {
  ...
  useEffect(() => {
    const fetchBusinesses = async () => {
      try {
        const response = await axios.get(`${BASE_URL}/getBusinessesByLocation/Casiguran`);
  ...
  return (
    <div className="font-sans mt-5  mx-auto w-full ">
      ...
      <h1 className="text-4xl font-bold  text-center">Casiguran, Sorsogon</h1>
      </div>
      
      {/* Image Collage */}
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 mb-6">
        <img src={casiguranpic1 } className="col-span-2 md:col-span-2 row-span-2 rounded-lg w-full h-full  " />
        <img src={casiguranpic2 } className="rounded-lg w-full h-32 md:h-60 " />
        <img src={casiguranpic3 } className="rounded-lg object-cover w-full h-32 md:h-60" />
        <img src={casiguranpic4 } className="rounded-lg object-cover w-full h-32 md:h-60" />
        <img src={casiguranpic5 }  className="rounded-lg object-cover w-full h-32 md:h-60" />
      </div>
