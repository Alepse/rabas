...
const Sorsogon = () => {
  ...
  useEffect(() => {
    const fetchBusinesses = async () => {
      try {
        const response = await axios.get(`${BASE_URL}/getBusinessesByLocation/Sorsogon`);
  ...
  return (
    ...
    <div className='p-[4rem]'>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 mb-6">
        <img src={sorsogonpic1} className="col-span-2 md:col-span-2 row-span-2 rounded-lg w-full h-full   " />
        <img src={sorsogonpic2  }  className="rounded-lg w-full h-32 md:h-60 " />
        <img src={sorsogonpic3 } className="rounded-lg object-cover w-full h-32 md:h-60" />
        <img src={sorsogonpic4}  className="rounded-lg object-cover w-full h-32 md:h-60" />
        <img src={sorsogonpic5 }  className="rounded-lg object-cover w-full h-32 md:h-60" />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <section className='bg-white rounded-lg p-6 shadow-md'>
          ...
          Sorsogon City, the capital of the province, has been a major center of trade, governance, and culture since the Spanish era. Known for its historical significance, it was a bustling hub for the Spanish administration in the Bicol region. Over the years, Sorsogon City has evolved into a progressive urban center while retaining its unique cultural identity.
          </p>
        </section>
        ...
        <section className='bg-white rounded-lg p-6 shadow-md'>
          ...
          <p className="text-gray-700">
          Sorsogon City is located at the southern tip of Luzon, with a geography that includes coastal areas along Sorsogon Bay and mountainous regions inland. The city enjoys a tropical climate with rich soils that support agriculture, particularly coconut and rice farming, as well as a strong fishing industry. Its central location in the province makes it a gateway to Sorsogon’s various tourist attractions.
          </p>
        </section>
        ...
        <section className='bg-white rounded-lg p-6 shadow-md'>
          ...
          <p className="text-gray-700">
          Sorsogon City is known for its blend of historical sites, vibrant food scene, and commercial establishments. The city’s scenic coastline along Sorsogon Bay offers beautiful views, and its bustling markets provide fresh local produce and seafood. The “Kasanggayahan Festival,” celebrating the city’s prosperity and culture, is one of the largest festivals in the region, drawing visitors from around the province.
          </p>
        </section>
      </div>
      ...
      <h2 className="text-2xl font-semibold mb-4">Locations</h2>
        <div className='flex justify-center'>
          ...
          <div className="mt-8 z-10  bg-color1 rounded-lg shadow-md p-1 w-full bg-gradient-to-r from-color1 to-color2">
            <MapSection businesses={businesses} initialCenter={[12.970618649435574,124.00508014287041]} currentZoom={currentZoom} setCurrentZoom={setCurrentZoom} />
          </div>
        </div>
      </div>
