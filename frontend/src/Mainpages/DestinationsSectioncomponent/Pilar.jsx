  ...
  return (
    <div className="font-sans mt-5 p-5 mx-auto w-full max-w-7xl">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 mb-6">
        <img src={pilarpic1 } className="col-span-2 md:col-span-2 row-span-2 rounded-lg w-full h-[31rem]  " />
      ...
      <div className="mt-8">
        ...
        <div className="bg-gray-200 h-96 rounded-lg flex items-center justify-center p-4">
          <p className="text-gray-500">Map of Pilar, Sorsogon (Placeholder)</p>
        </div>
      </div>
