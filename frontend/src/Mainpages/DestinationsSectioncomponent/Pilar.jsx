...
const Pilar = () => {
  ...
  useEffect(() => {
    const fetchBusinesses = async () => {
      try {
        const response = await axios.get('http://localhost:5000/getBusinessesByLocation/Pilar');
  ...
  return (
    <div className="font-sans mt-5 p-5 mx-auto w-full max-w-7xl">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 mb-6">
        ...
        <img src={pilarpic2  }  className="rounded-lg w-full h-60 " />
        <img src={pilarpic3 } className="rounded-lg object-cover w-full h-60" />
        <img src={pilarpic4 }  className="rounded-lg object-cover w-full h-60" />
        <img src={pilarpic5 }  className="rounded-lg object-cover w-full h-60" />
      </div>
