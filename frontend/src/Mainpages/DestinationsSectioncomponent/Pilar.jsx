...
const Pilar = () => {
  ...
  useEffect(() => {
    const fetchBusinesses = async () => {
      try {
        const response = await axios.get(`${BASE_URL}/getBusinessesByLocation/Pilar`);
  ...
  return (
    ...
    <div className='p-[4rem]'>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 mb-6">
        <img src={pilarpic1 } className="col-span-2 md:col-span-2 row-span-2 rounded-lg w-full h-full  " />
        <img src={pilarpic2  }  className="rounded-lg w-full h-32 md:h-60 " />
        <img src={pilarpic3 } className="rounded-lg object-cover w-full h-32 md:h-60" />
        <img src={pilarpic4 }  className="rounded-lg object-cover w-full h-32 md:h-60" />
        <img src={pilarpic5 }  className="rounded-lg object-cover w-full h-32 md:h-60" />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <section className='bg-white rounded-lg p-6 shadow-md'>
          ...
          Pilar has a history steeped in fishing and trade. Established as a coastal community, Pilar’s economy grew through its strong fishing industry, which remains a major part of its identity.
          </p>
        </section>
        ...
        <section className='bg-white rounded-lg p-6 shadow-md'>
          ...
          <p className="text-gray-700">
          Situated along Sorsogon Bay, Pilar is surrounded by fertile lands and rich fishing grounds. Its tropical climate supports a variety of marine resources, making it one of the best places for seafood lovers.
          </p>
        </section>
        ...
        <section className='bg-white rounded-lg p-6 shadow-md'>
          ...
          <p className="text-gray-700">
          Pilar is renowned for its crabs, prawns, and other seafood delicacies. The “Sirangan Festival” highlights Pilar’s vibrant fishing culture with festivities centered around seafood. Its scenic views of the bay make Pilar a relaxing destination for visitors.
          </p>
        </section>
      </div>
      ...
      <h2 className="text-2xl font-semibold mb-4">Locations</h2>
        <div className='flex justify-center'>
          ...
          <div className="mt-8 z-10  bg-color1 rounded-lg shadow-md p-1 w-full bg-gradient-to-r from-color1 to-color2">
            <MapSection businesses={businesses} initialCenter={[12.923474264690068,123.67528011826549]} currentZoom={currentZoom} setCurrentZoom={setCurrentZoom} />
          </div>
        </div>
      </div>
