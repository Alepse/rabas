  ...
  return (
    <div className="font-sans mt-5  mx-auto w-full  ">
     <div className='p-[4rem]'>
      <h1 className="text-4xl font-bold  text-center">Irosin, Sorsogon</h1>
      </div>
      ...
      <h2 className="text-2xl font-semibold mb-4">Locations</h2>
        <div className='flex justify-center'>
          ...
          <div className="mt-8 z-10  bg-color1 rounded-lg shadow-md p-1 w-full bg-gradient-to-r from-color1 to-color2">
            <MapSection businesses={businesses} initialCenter={[12.703997419528523,124.03177267346597]} currentZoom={currentZoom} setCurrentZoom={setCurrentZoom} />
          </div>
        </div>
      </div>
