...
const Castilla = () => {
  ...
  return (
    <div className="font-sans mt-5  mx-auto w-full  ">
      ...
      <h1 className="text-4xl font-bold  text-center">Castilla, Sorsogon</h1>
      </div>
      
      {/* Image Collage */}
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 mb-6">
        <img src={castillapic1 } className="col-span-2 md:col-span-2 row-span-2 rounded-lg w-full h-full  " />
        <img src={castillapic2 } className="rounded-lg w-full h-32 md:h-60 " />
        <img src={castillapic3 }  className="rounded-lg object-cover w-full h-32 md:h-60" />
        <img src={castillapic4 }  className="rounded-lg object-cover w-full h-32 md:h-60" />
        <img src={castillapic5 }  className="rounded-lg object-cover w-full h-32 md:h-60" />
      </div>
