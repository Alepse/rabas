...
const Juban = () => {
  ...
  useEffect(() => {
    const fetchBusinesses = async () => {
      try {
        const response = await axios.get(`${BASE_URL}/getBusinessesByLocation/Juban`);
  ...
  return (
    <div className="font-sans mt-5  mx-auto w-full  ">
      ...
      <h1 className="text-4xl font-bold  text-center">Juban, Sorsogon</h1>
      </div>
      
      {/* Image Collage */}
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 mb-6">
        <img src={jubanpic1 } className="col-span-2 md:col-span-2 row-span-2 rounded-lg w-full h-full  " />
        <img src={jubanpic2 }  className="rounded-lg w-full h-32 md:h-60 " />
        <img src={jubanpic3 } className="rounded-lg object-cover w-full h-32 md:h-60" />
        <img src={jubanpic4}  className="rounded-lg object-cover w-full h-32 md:h-60" />
        <img src={jubanpic5 }  className="rounded-lg object-cover w-full h-32 md:h-60" />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <section className='bg-white rounded-lg p-6 shadow-md'>
          ...
          Juban is one of Sorsogon’s historic towns, known for its Spanish colonial houses and ancestral homes that have been preserved for generations. The town reflects the traditional architecture of the Bicol region, with houses made from nipa and bamboo.
          </p>
        </section>
        ...
        <section className='bg-white rounded-lg p-6 shadow-md'>
          ...
          <p className="text-gray-700">
          Located in a valley, Juban’s geography includes flatlands and rolling hills. Its mild climate and fertile land make it ideal for farming, and its location provides easy access to surrounding areas.
          </p>
        </section>
        ...
        <section className='bg-white rounded-lg p-6 shadow-md'>
          ...
          <p className="text-gray-700">
          Juban is known for its ancestral houses, which stand as testaments to the town’s rich history. The annual “Kinsa Festival” celebrates the preservation of Juban’s heritage, offering a glimpse into the town’s past through performances and parades.
      ...
      <h2 className="text-2xl font-semibold mb-4">Locations</h2>
        <div className='flex justify-center'>
          ...
          <div className="mt-8 z-10  bg-color1 rounded-lg shadow-md p-1 w-full bg-gradient-to-r from-color1 to-color2">
            <MapSection businesses={businesses} initialCenter={[12.847753614946939,123.9889511238557]} currentZoom={currentZoom} setCurrentZoom={setCurrentZoom} />
          </div>
        </div>
      </div>
