  ...
  return (
    ...
    <div className='p-[4rem]'>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 mb-6">
        ...
        <img src={barcelonapic2} className="rounded-lg w-full h-32 md:h-60 object-cover" />
        <img src={barcelonapic3} className="rounded-lg w-full h-32 md:h-60 object-cover" />
      ...
      <div className="mt-8">
        ...
        <div className='flex justify-center'>
          ...
          <div className="mt-8 z-10  bg-color1 rounded-lg shadow-md p-1 w-full bg-gradient-to-r from-color1 to-color2">
            <MapSection businesses={businesses} initialCenter={[12.867995441373473, 124.14189813522965]} currentZoom={currentZoom} setCurrentZoom={setCurrentZoom} />
          </div>
        </div>
      </div>
