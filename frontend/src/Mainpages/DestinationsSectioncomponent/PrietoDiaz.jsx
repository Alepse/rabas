...
const PrietoDiaz = () => {
  ...
  useEffect(() => {
    const fetchBusinesses = async () => {
      try {
        const response = await axios.get(`${BASE_URL}/getBusinessesByLocation/PrietoDiaz`);
  ...
  return (
    <div className="font-sans mt-5  mx-auto w-full  ">
     <div className='p-[4rem]'>
      <h1 className="text-4xl font-bold  text-center">PrietoDiaz, Sorsogon</h1>
      </div>
      
      {/* Image Collage */}
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 mb-6">
        <img src={prietopic1} className="col-span-2 md:col-span-2 row-span-2 rounded-lg w-full h-full  " />
        <img src={prietopic2  }  className="rounded-lg w-full h-32 md:h-60 " />
        <img src={prietopic3 } className="rounded-lg object-cover w-full h-32 md:h-60" />
        <img src={prietopic4 }  className="rounded-lg object-cover w-full h-32 md:h-60" />
        <img src={prietopic5 }  className="rounded-lg object-cover w-full h-32 md:h-60" />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <section className='bg-white rounded-lg p-6 shadow-md'>
          ...
          Prieto Diaz, named after two Spanish friars, has a long history as a coastal community shaped by both Spanish colonial influences and local traditions. The town was a strategic location during the Spanish era, serving as a defense point against pirate invasions along the coast. Its historical roots can be seen in the customs and traditions preserved by the community over the years.
          </p>
        </section>
        ...
        <section className='bg-white rounded-lg p-6 shadow-md'>
          ...
          <p className="text-gray-700">
          Located on the eastern coast of Sorsogon, Prieto Diaz is surrounded by lush mangrove forests and bordered by the Pacific Ocean. Its geography includes flatlands and coastal areas that support both agriculture and fishing. The town’s ecosystem is rich in marine life, and the mangroves protect the shoreline, making it a vital location for biodiversity conservation.
          </p>
        </section>
        ...
        <section className='bg-white rounded-lg p-6 shadow-md'>
          ...
          <p className="text-gray-700">
          Prieto Diaz is renowned for its expansive mangrove forests, which offer eco-tourism activities such as kayaking and guided tours. The “Karagumoy Festival” is celebrated annually, named after a local plant used to create traditional handicrafts, and showcases the town’s dedication to preserving its natural resources and cultural heritage.
          </p>
        </section>
      </div>
      ...
      <h2 className="text-2xl font-semibold mb-4">Locations</h2>
        <div className='flex justify-center'>
          ...
          <div className="mt-8 z-10  bg-color1 rounded-lg shadow-md p-1 w-full bg-gradient-to-r from-color1 to-color2">
            <MapSection businesses={businesses} initialCenter={[13.040356870770516,124.19339704070971]} currentZoom={currentZoom} setCurrentZoom={setCurrentZoom} />
          </div>
        </div>
      </div>
