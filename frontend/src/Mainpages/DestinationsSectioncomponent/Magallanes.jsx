...
const Magallanes = () => {
  ...
  useEffect(() => {
    const fetchBusinesses = async () => {
      try {
        const response = await axios.get(`${BASE_URL}/getBusinessesByLocation/Magallanes`);
  ...
  return (
    <div className="font-sans mt-5  mx-auto w-full  ">
      ...
      <h1 className="text-4xl font-bold  text-center">Magallanes, Sorsogon</h1>
      </div>
      
      {/* Image Collage */}
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 mb-6">
        <img src={magallanespic1} className="col-span-2 md:col-span-2 row-span-2 rounded-lg w-full h-full " />
        <img src={magallanespic2 }  className="rounded-lg w-full  h-32 md:h-60 " />
        <img src={magallanespic3 } className="rounded-lg object-cover w-full  h-32 md:h-60" />
        <img src={magallanespic4}  className="rounded-lg object-cover w-full  h-32 md:h-60" />
        <img src={magallanespic5}  className="rounded-lg object-cover w-full  h-32 md:h-60" />
      </div>
      ...
      <h2 className="text-2xl font-semibold mb-4">Locations</h2>
        <div className='flex justify-center'>
          ...
          <div className="mt-8 z-10  bg-color1 rounded-lg shadow-md p-1 w-full bg-gradient-to-r from-color1 to-color2">
            <MapSection businesses={businesses} initialCenter={[12.828422361316417,123.83415383587453]} currentZoom={currentZoom} setCurrentZoom={setCurrentZoom} />
          </div>
        </div>
      </div>
