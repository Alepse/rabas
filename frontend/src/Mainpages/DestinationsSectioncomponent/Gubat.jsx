...
import gubatpic1 from '@/assets/gubat.webp'
import gubatpic2 from '@/assets/gubatpic1.webp'
import gubatpic3 from '@/assets/gubatpic2.webp'
import gubatpic4 from '@/assets/gubatpic3.webp'
import gubatpic5 from '@/assets/gubatpic4.webp'
...
const Gubat = () => {
  ...
  useEffect(() => {
    const fetchBusinesses = async () => {
      try {
        const response = await axios.get(`${BASE_URL}/getBusinessesByLocation/Gubat`);
  ...
  return (
    <div className="font-sans mt-5  mx-auto w-full  ">
      ...
      <h1 className="text-4xl font-bold  text-center">Gubat, Sorsogon</h1>
      </div>
      
      {/* Image Collage */}
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 mb-6">
        <img src={gubatpic5}  className="col-span-2 md:col-span-2 row-span-2 rounded-lg w-full  " />
        <img src={gubatpic2}  className="rounded-lg w-full h-32  md:h-52 " />
        <img src={gubatpic3} className="rounded-lg object-cover w-full h-32 md:h-52" />
        <img src={gubatpic4}  className="rounded-lg object-cover w-full h-32  md:h-48" />
        <img src={gubatpic1} className="rounded-lg object-cover w-full h-32  md:h-48" />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <section className='bg-white rounded-lg p-6 shadow-md'>
          ...
          <p className="text-gray-700">
            Gubat, one of the oldest towns in Sorsogon, was established during the Spanish colonial era. Its history reflects a mix of farming and fishing cultures, and it has long been known for its traditional Bicolano way of life.
          </p>
        </section>
        ...
        <section className='bg-white rounded-lg p-6 shadow-md'>
          ...
          <p className="text-gray-700">
            Gubat lies along the eastern coastline, with flatlands and a warm, tropical climate. The long coastline provides beautiful beaches and rich fishing grounds, making fishing one of the town's main industries.
          </p>
        </section>
        ...
        <section className='bg-white rounded-lg p-6 shadow-md'>
          ...
          <p className="text-gray-700">
            Gubat is known for its surfing spots, particularly on Rizal Beach, where waves are ideal for surfers of all levels. The town hosts the annual "Pura Vida Surf Festival," attracting both local and international surfers and promoting Gubat's natural beauty and welcoming community.
          </p>
        </section>
      </div>
      ...
      <h2 className="text-2xl font-semibold mb-4">Locations</h2>
        <div className='flex justify-center'>
          ...
          <div className="mt-8 z-10  bg-color1 rounded-lg shadow-md p-1 w-full bg-gradient-to-r from-color1 to-color2">
            <MapSection businesses={businesses} initialCenter={[12.917752090159365,124.12318315594192]} currentZoom={currentZoom} setCurrentZoom={setCurrentZoom} />
          </div>
        </div>
      </div>
