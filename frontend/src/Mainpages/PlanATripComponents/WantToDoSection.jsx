...
const encryptId = (id) => {
  ...
  const WantToDoSection = ({ isOpen, onClose, onAddItem })  => {
    ...
    const renderFilters = (filters, setFilters, types, additionalFilters = null, isAllTab = false) => {
        ...
        <div className="w-full max-h-screen overflow-auto scrollbar-custom  ">
            <div className="bg-white shadow-slate-500  p-2 rounded-lg shadow-lg">
    ...
    return (
        <div
            className="rounded-lg bg-white shadow-lg max-h-[85vh] overflow-auto scrollbar-custom" 
        >
            <div>               
                <div className='bg-light'>
                    ...
                    <Tabs
                        ...
                        variant="underlined"
                        className="mb-4 bg-white overflow-x-auto w-full"
                ...
                <div className=' bg-white flex items-center w-full border'>
