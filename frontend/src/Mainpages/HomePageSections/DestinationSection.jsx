...
import wave from '@/assets/wave-haikei.webp'
  ...
  return (
    <section className='   mx-auto bg-transparent p-8 ' style={{  
      ...
      <div className='flex flex-col mt-10 container '>
        ...
        <Link className='rounded-full text-center bg-color1 ml-1 text-white p-2 text-sm hover:bg-color2 duration-300 hover:translate-x-2 flex items-center hover:shadow-lg mt-4 ' to='/destinations' >
