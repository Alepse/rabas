...
const AccommodationsTab = () => {
  ...
  return (
    <div className='lg:container'>
      <AccommodationSwiper 
        title="Design Meets Comfort: Accommodation Recommendations" 
        link="/accommodations" 
        accommodations={designMeetsComfort} 
        loading={loading} 
        uniqueId="deignMeetsComfort"
      />
      <AccommodationSwiper 
        title="Traveler's Choice: Most Liked Stays" 
        link="/accommodations" 
        accommodations={travelersChoice} 
        loading={loading} 
        uniqueId="traversChoice"  
      />
      <AccommodationSwiper 
...
const AccommodationSwiper = ({ title, link, isLast, accommodations, loading, uniqueId }) => {
                    ...
                    <div className="flex-grow flex flex-col justify-between mt-4 px-2">
                            ...
                            {accommodation.rating ? (
                              <>
                                <span className="text-[12px]">
                                  {parseFloat(accommodation.rating).toFixed(1)}
                                </span>
                      ...
                      <div className="mt-auto">
                        <p className="text-md font-semibold text-black mb-4">
                          {accommodation.lowest_price === null &&
                          accommodation.highest_price === null ? (
                            ...
                            <>
                              ...
                              <span className="text-red-500 text-xl font-bold ml-2">
                                ₱
                                {accommodation.lowest_price -
                                  (accommodation.highest_price * accommodation.discount) /
                                    100}
                              </span>
                            </>
                          ) : (
