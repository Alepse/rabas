...
export const addActivityDeals = createAsyncThunk(
  'activityDeals/addActivityDeals',
...
export const updateActivityDeals = createAsyncThunk(
...
const activityDealsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
     ...
     .addCase(addActivityDeals.pending, (state) => {
        state.status = 'loading';
      })
      .addCase(addActivityDeals.fulfilled, (state, action) => {
        state.status = 'succeeded';
      })
      .addCase(addActivityDeals.rejected, (state, action) => {
        state.status = 'failed';
        state.error = action.error.message || 'Failed to add deal';
      })
      .addCase(updateActivityDeals.pending, (state) => {
        state.status = 'loading';
      })
      .addCase(updateActivityDeals.fulfilled, (state, action) => {
        state.status = 'succeeded';
      })
      .addCase(updateActivityDeals.rejected, (state, action) => {
          state.status = 'failed';
