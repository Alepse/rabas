...
const heroabout = () => {
  return (
    <div className="relative flex flex-col items-center justify-center mx-auto bg-cover  bg-center h-[300px] mt-12 " style={{  
      ...
      <div className="relative flex flex-col items-center justify-center">  
        <h1 className="text-light text-center text-5xl mb-1">About RabaSorsogon</h1> 
